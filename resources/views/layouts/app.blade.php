    ...
    <header class=" bg-color1">
        ...
        <nav class="navbar py-0 pt-1  navbar-expand-lg">
            <div class="container p-0">
              <a class="navbar-brand mobile-center" href="#">
                <img src=" {{asset('/images/logo-mercatus-africa.png')}} " alt="logo de mercatus africa">
              </a>

              <form method= "GET" action="#" enctype="multipart/form-data" class="d-flex rounded-2 shadow search-bg-color1 w-search" role="search">
                @csrf
              ...
              <div class="collapse navbar-collapse flex-grow-0" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link fs-nav d-flex text-white" href="#">
          ...
          <div class="container px-0 zero">
            ...
            <a class = " nav-link fs-5 text-white " href = "#">Immobilier</a>
                <a class = "nav-link fs-5 text-white" href = "#">Electronique</a>
                <a class = "nav-link fs-5 text-white" href = "#">Informatique</a>
                <a class = "nav-link fs-5 text-white" href = "#">Mode</a>
                <a class = "nav-link fs-5 text-white" href = "#">Véhicule</a>
                <a class = "nav-link fs-5 text-white" href = "#">Emploi</a>
                <a class = "nav-link fs-5 text-white" href = "#">Pour la maison</a>
                <a class = "nav-link fs-5 text-white" href = "#">loisirs</a>
                <a class = "nav-link fs-5 text-white" href = "#">Autres</a>
              </nav>
          </div>
        </nav>
      ...
      <footer class="footer-bg-color">
        <div class="container pb-0 p-2">
          <div class="d-flex justify-content-between flex-wrap p-3">
            <div>
            <a class="nav-link fs-4 text-white" href="#">Á propos de nous</a>
            ...
            <div>
            <a class="nav-link fs-4 text-white" href="#">Informations légales</a>
            ...
            <div>
              ...
              <form action="">
                <div class="mb-3">
                  <div class="d-flex">
                    <input type="email" class="form-control text-black h-100 rounded-newsletter" placeholder="Email" id="exampleInputEmail1" aria-describedby="emailHelp">
